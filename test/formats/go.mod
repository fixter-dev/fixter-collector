// Test-only module: the format verification suite. Separate from the OCB-generated
// module in _build/ so `go test` here never perturbs the collector build.
module github.com/fixter-dev/fixter-collector/test/formats
